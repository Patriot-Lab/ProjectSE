...
sign_image("images/landscape.png", "keys/signature.sig", "keys/public_key.pub")
is_valid = verify_image_signature("images/landscape.png", "keys/signature.sig", "keys/public_key.pub")
